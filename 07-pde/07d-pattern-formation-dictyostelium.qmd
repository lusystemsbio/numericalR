...
`matplotlib.animation`. Both loops below are shown as code you can run; the resulting
GIFs are pre-generated and embedded so the book does not rebuild them on every
render.
