...
$$ \frac{dX}{dt} = f(X)$$
with an overdamped particle in 1D. For the overdamped particle, $X$ represents its position in 1D, $-f(X)$ is the force, $\frac{dX}{dt}$ represents the velocity of the particle. Here, velocity is proportional to the force for an overdamped system. Therfore, we can define the potential function
