...
We can simulate the dynamics of $X$ and $Y$ with 4th order Runge-Kutta (RK4). The function RK4_2D for a system with two variables is very similar to the function RK4 in Part 2B. Now, the time trajectory is stored in a matrix called X_all.
