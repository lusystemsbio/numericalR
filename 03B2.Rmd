...
<center> ![arc length continuation](./extra/data/02D/fig2.png){width=50%} </center>
<br/>
...
dCdt1 = func_g(null1_1[,1], null1_1[,2],alpha1, alpha2)  #dC/dt along the nullcline dN/dt = 0 first part (N = 0)
dCdt2 = func_g(null1_2[,1], null1_2[,2],alpha1, alpha2)  #dC/dt along the nullcline dN/dt = 0 second part (C = 1/(alpha1 - 1))
