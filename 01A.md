...
```
    ...
    ##             [,1]       [,2]        [,3]       [,4]
    ## [1,]  3.34840063  0.2994124  0.07208216 -0.1968725
    ## [2,]  0.01452122 -0.1090686 -0.42321761  0.5025703
    ## [3,] -1.34016296 -0.9214317 -0.17566972 -0.9264722
    ## [4,] -0.10481810 -0.4189668  0.44969997  1.4097254

``` r
apply(mat, 1, sum)   # row sum
```

    ## [1]  3.52302276 -0.01519473 -3.36373654  1.33564050
...
```
    ...
    ## [1]  1.91794081 -1.15005466 -0.07710519  0.78895103
...
```
    ...
    ## [1]  0.4794852 -0.2875137 -0.0192763  0.1972378
...
```
    ...
    ## [1] 1.7392094 0.4459419 0.3224564 0.8633367
