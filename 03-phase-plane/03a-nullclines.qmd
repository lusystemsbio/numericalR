...
Part 3 generalizes the single-variable methods of Part 2 to systems of *two*
...
$$ X(Y) = \frac{g_{X0} + g_{X1}\dfrac{1}{1 + (Y/Y_{th})^{n_Y}}}{k_X} , \qquad
   Y(X) = \frac{g_{Y0} + g_{Y1}\dfrac{1}{1 + (X/X_{th})^{n_X}}}{k_Y} . \tag{3} $$
