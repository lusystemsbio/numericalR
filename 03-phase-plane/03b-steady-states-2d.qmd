...
signals a spiral. Part 3G shows several gene circuits with the different types of
stability. For the toggle switch, the two outer steady states are stable and the
...
the two outer attractors while the middle crossing repelled them. Part 3G
revisits stability for circuits that also produce spirals.
