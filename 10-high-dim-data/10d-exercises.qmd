...
The corresponding network is shown below (pink: the three signalling nodes, which serve as the input control; orange: network genes; green edges: activation; red edges: inhibition).
