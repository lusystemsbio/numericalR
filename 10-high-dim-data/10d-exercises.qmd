...
The corresponding network is shown below (pink: the three signalling inputs; gold: every other node, covering both the signalling effectors and the transcription factors; green edges: activation; red edges: inhibition).
