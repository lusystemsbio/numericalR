...
#### Apply
Another unique feature in R. Apply performs a function iteratively through an array or matrix. It's usually a more efficient way than a for loop. Syntax: apply(X, MARGIN, FUN). Here, X is an array or matrix. MARGIN=1 performs the specified function by rows, 2 by columns. FUN: is the function to apply. 
```{r}
