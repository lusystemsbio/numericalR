...
For a steady state $X_s$, the value is time indepedent. Thus, the condition of steady states is the same as that for an ODE, *i.e.*,
...
* Other than the numerical method introduced above, there are more efficient way to solve DDEs. We will leave it as an exercise.
