...
the gap. The takeaway is not that libraries are slow — they are robust and
general — but that a compiled kernel wins for tight inner loops.
...
RK2 and especially Euler differ more — confirming the compiled and interpreted
RK4 agree.
